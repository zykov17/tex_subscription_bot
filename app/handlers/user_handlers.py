    ...
    try:
        ...
        async for session in db.get_session():
            ...
            if is_subscribed:
                ...
                await message.answer(
                    f"👋 Привет, {first_name}!\n\n"
                    f"Чтобы получить подарок, подпишитесь на наш канал: {config.CHANNEL_ID}\n\n"
        ...
        async for session in db.get_session():
            ...
            if is_subscribed:
                ...
                await callback.message.edit_text(
                    ...
                    f"Пожалуйста, подпишитесь на {config.CHANNEL_ID} и нажмите проверку снова:",
                    reply_markup=create_subscription_keyboard()
                )
