        ...
        try:
            ...
            if is_subscribed:
                ...
                await message.answer(
                    ...
                    f"1️⃣ Подпишись на наш канал: <a href='https://t.me/{config.CHANNEL_USERNAME}'>Текстилия</a> — там мы публикуем новые коллекции, советы и эксклюзивные предложения.\n\n"
                    "2️⃣ После подписки нажми кнопку 'Проверить подписку' ниже, чтобы получить ваш промокод на подарок\n\n"
                    "💡 Промокод действует только при первом заказе и даёт право на 4 катушки ниток. Не упустиnt шанс\n\n"
